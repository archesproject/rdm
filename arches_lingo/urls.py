...
from arches_lingo.views.api.pythonic_models import (
    ...
    SchemeNoteView,
    SchemeRightsView,
    SchemeRightDetailView,
    SchemeRightStatementsView,
    SchemeRightStatementDetailView,
...
urlpatterns = [
    ...
    path(
        "api/scheme/right_statements",
        SchemeRightStatementsView.as_view(),
        name="api-scheme-rights-statement-list-create",
    ),
    path(
        "api/scheme/<uuid:resource_id>/rights_statement/<uuid:pk>",
        SchemeRightStatementDetailView.as_view(),
        name="api-scheme-rights-statement",
    ),
    path(
